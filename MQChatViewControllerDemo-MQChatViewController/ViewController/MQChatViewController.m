...
//    [self setupUI];
//    if (recrodView && [recrodView.superview isEqual:mainView]) {
//        recrodView.frame = CGRectMake(0, 0, chatView.frame.size.width, chatView.frame.size.height);
//        [recrodView setupUI];
//    }
}
...
//    [chatView scrollToBottom:YES];
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"MCToolbarDownBtnVisible" object:nil];
}
