...
第三方开源库 | Tag 版本 | 说明
----- | ----- | -----
[SDWebImage](https://github.com/rs/SDWebImage) | 3.7.5 | 知名的异步图片下载和图片缓存库；
...
[MHFacebookImageViewer](https://github.com/michaelhenry/MHFacebookImageViewer) | 自定义 | 图片查看器；**注意**，我们对该开源库进行了修改，以支持单击关闭Viewer等一些操作，该修改版本可见 [MHFacebookImageViewer](https://github.com/ijinmao/MHFacebookImageViewer)；
[FBDigitalFont](https://github.com/lyokato/FBDigitalFont) | 0.0.4 | 类 LED 显示效果，用于本项目中的语音倒计时显示；
